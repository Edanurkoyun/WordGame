...
public class WordsGrid : MonoBehaviour
{
    ...
    // Grid karelerinin doðru pozisyonlarýný ayarlar
    private void SetSquaresPosition()
    {
        // Ýlk karenin boyutlarýný ve ölçeðini al
        ...
        // Tüm kareler için pozisyon belirle
    ...
    private void SpawnGridSquares()
    {
        if(currentGameData != null)
        {
            ...
            foreach (var squares in currentGameData.selectedBoardData.Board)
            {
                ...
                {
                    // Harflerin verilerini al (normal, seçili ve yanlýþ durumlar)
                    ...
                    {
                       Debug.LogError("Panodaki Verilerden Rastgele Harf Eklemek için Rastgele Harf Doldur Butonuna Týklayýnýz. Eksik Harf: "+ squareLetter);
                    ...
                    {
                        // Kareyi oluþtur ve listeye ekle
    ...
    // Karelerin ekran boyutlarýna sýðmasý gerektiðini kontrol eder
    ...
    // Ekranýn yarý geniþliðini hesaplar
